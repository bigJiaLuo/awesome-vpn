...
echo ---------------------------------------
echo Menu:
echo       ①  Set Teredo Server
echo.
echo       ②  Teredo Tunnel Status
echo.
echo       Ｑ  Quit
echo.
echo ---------------------------------------
if %var% neq 0 echo (Input invalid please re - input)
Set choice=
Set /p choice=choice:
Set "choice=%choice:"=%"
...
echo.
echo ---------------------------------------
if %var2% neq 0 echo (Input invalid please re - input)
Set choice2=
Set /p choice2=choice2:
Set "choice2=%choice2:"=%"
